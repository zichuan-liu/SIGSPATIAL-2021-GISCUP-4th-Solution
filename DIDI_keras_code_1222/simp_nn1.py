    ...
    if is_tfidf:
        if not is_save_tfidf:
            ...
            tfidf_matrix.to_pickle(
                    r'./giscup_2021/tfidf_matrix_fea_' + str(train_rnn_listnum) + '.pkl')
            if is_Test:
            ...
            tfidf_matrix = pd.read_pickle(r'./giscup_2021/tfidf_matrix_fea_' + str(train_rnn_listnum) + '.pkl')  # , nrows = 148457
            if is_Test:
                tfidf_matrix = tfidf_matrix.head(148457)
...
def w2v_fea(data, train_rnn_listnum=0, w2v_size=32, is_w2v=is_w2v, is_save_w2v=is_save_w2v):
    if is_w2v:
        if not is_save_w2v:
            ...
            lkid_vecs.to_pickle(
                r'./giscup_2021/lkid_vecs_fea_' + str(train_rnn_listnum) + '.pkl')
            if is_Test:
            ...
            lkid_vecs = pd.read_pickle(r'./giscup_2021/lkid_vecs_fea_' + str(
