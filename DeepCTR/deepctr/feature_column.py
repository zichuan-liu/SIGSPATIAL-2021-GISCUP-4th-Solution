...
def build_input_features(feature_columns, prefix='', add_fea_columns_shape = {}):
    ...
    if add_fea_columns_shape is not {}:
        for fc in add_fea_columns_shape.keys():
            input_features[fc] = Input(shape=add_fea_columns_shape[fc], name=fc)
